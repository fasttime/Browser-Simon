...
a.b("DOMContentLoaded",function(){document.title="Browser Simon";a(document.head,a("META",{content:"initial-scale=1",name:"viewport"}));a(document.documentElement,a.b("mouseup",c),a.b("touchend",c));var b=a("H1",{style:{font:"bold 28px/100% Georgia",margin:"28px 0",textAlign:"center"}},a("SPAN",{style:{color:"#49F",letterSpacing:"1px"}},"BROWSER"),a("BR"),a("SPAN",{style:{fontSize:"150%"}},"s\u0131mon"));v=a("DIV");var e=a("DIV",{style:{position:"relative",width:"300px",height:"300px"}},v);a.a(".tile",
{"box-shadow":"5px 5px 2.5px #ABABAB",position:"absolute",width:"145px",height:"145px"});a.a(".down",{margin:"3px 0 0 3px"});a.a(".lit,.smooth",{transition:"background 120ms ease, box-shadow 120ms ease, margin 120ms ease"});a.a(".ready *",{cursor:"pointer"});var k={};[{name:"green",frequency:415.305,background:"#DBFFBD",f:"#9F4",g:"#67AB2E"},{name:"red",frequency:311.127,background:"#FFBDBD",f:"#F44",g:"#AB2E2E"},{name:"yellow",frequency:246.942,background:"#FFFFBD",f:"#FF4",g:"#ABAB2E"},{name:"blue",
frequency:207.652,background:"#BDDBFF",f:"#49F",g:"#2E67AB"}].forEach(function(b,d){var g=b.background,e=b.f,f=b.name,l=b.g;b=a("DIV",{className:"tile "+f,dataset:{frequency:b.frequency}},a.b("mousedown",h),a.b("touchstart",h),a.b("mouseout",c));var m=[0,0,0,0],n=d^d>>1;m[n]="145px";a.a("."+f,{background:g,"border-radius":m.join(" "),left:150*(d&1)+"px",top:150*(d>>1)+"px"});a.a(".down."+f,{background:e,"box-shadow":"2px 2px 2.5px "+l});a.a(".lit."+f,{background:e,"box-shadow":"5px 5px 2.5px "+l});
a(v,b);k[25*n+"%"]={color:e}});k["100%"]=k["0%"];a.a.s("start",k);var f=a("DIV",{className:"start"},"Start",a.b("click",g));f=a("DIV",{className:"startLayer"},{style:{background:"#888",borderWidth:"1px",position:"absolute",left:"100px",top:"100px",width:"100px",height:"100px"}},f);a(e,f);a.a(".start",{"align-items":"center",background:"#B0C4DE","border-width":"2px",color:"#434A54",cursor:"pointer",display:"flex",font:"bold 20px Verdana","justify-content":"center","letter-spacing":"1px",margin:"3px",
