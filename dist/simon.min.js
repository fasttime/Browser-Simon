...
position:"fixed",width:"92px",height:"92px"});a.a(".start:active",{animation:"start 1.5s infinite","border-color":"#AAA #DDD #DDD #AAA"});a.a(".start,.startLayer",{"border-color":"#DDD #AAA #AAA #DDD","border-radius":"100%","border-style":"solid","box-sizing":"border-box"});D=a("SPAN","\u2014");A=a("H2",{style:{textAlign:"center"}},"Hello");f=a("FOOTER",{style:{display:"table",margin:"18px 0",tableLayout:"fixed",whiteSpace:"nowrap",width:"100%"}},a("H2",{style:{overflowX:"auto"}},"Round: ",D),A);
a.a("h2",{display:"table-cell",font:"24px Verdana"});a(document.body,{style:{color:"#33A",WebkitTapHighlightColor:"transparent",userSelect:"none",WebkitUserSelect:"none"}},a("DIV",{style:{cursor:"default",margin:"0 auto",width:"300px"}},b,e,f))}))})();
