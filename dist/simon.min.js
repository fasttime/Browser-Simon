...
(function(){function p(){do v=v+1&2147483647||1;while(n.has(v));return v}function z(c,a){var d=p();n.set(d,{l:c,once:!1});c={};r.postMessage((c.action="REPEAT",c.id=d,c.delay=800,c.interval=a,c));return d}function q(c,a){var d=p();n.set(d,{l:c,once:!0});c={};r.postMessage((c.action="START",c.id=d,c.delay=a,c));return d}function k(c){if(n.delete(c)){var a={};r.postMessage((a.action="STOP",a.id=c,a))}}function a(a){this.i=a;B.add(this)}function g(c){w&&w.c();var d=x.createOscillator();d.connect(x.destination);
...
frequency:207.652,background:"#BDDBFF",f:"#49F",g:"#2E67AB"}].forEach(function(a,b){var c=a.name,d=art("DIV",{className:"tile "+c,dataset:{frequency:a.frequency}},art.b("mousedown",D),art.b("touchstart",D),art.b("mouseout",e)),f=[0,0,0,0],g=b^b>>1;f[g]="145px";var k=a.f,l=a.g;art.a("."+c,{background:a.background,"border-radius":f.join(" "),left:150*(b&1)+"px",top:150*(b>>1)+"px"});art.a(".down."+c,{background:k,"box-shadow":"2px 2px 2.5px "+l});art.a(".lit."+c,{background:k,"box-shadow":"5px 5px 2.5px "+
l});art(u,d);h[25*g+"%"]={color:k}});h["100%"]=h["0%"];art.a.o(h);var g=art("DIV",{className:"start"},"Start",art.b("click",f)),g=art("DIV",{className:"startLayer"},{style:{background:"#888",borderWidth:"1px",position:"absolute",left:"100px",top:"100px",width:"100px",height:"100px"}},g);art(b,g);art.a(".start",{"align-items":"center",background:"#B0C4DE","border-width":"2px",color:"#434A54",cursor:"pointer",display:"flex",font:"bold 20px Verdana","justify-content":"center","letter-spacing":"1px",
margin:"3px",width:"92px",height:"92px"});art.a(".start:active",{"animation-duration":"1.5s","animation-iteration-count":"infinite","animation-name":"start","border-left-color":"#AAA","border-right-color":"#DDD","border-top-color":"#AAA","border-bottom-color":"#DDD"});art.a(".start,.startLayer",{"border-radius":"100%","border-style":"solid","border-left-color":"#DDD","border-right-color":"#AAA","border-top-color":"#DDD","border-bottom-color":"#AAA","box-sizing":"border-box"});C=art("SPAN","\u2014");
y=art("H2",{style:{textAlign:"center"}},"Hello");g=art("FOOTER",{style:{display:"table",margin:"18px 0",tableLayout:"fixed",whiteSpace:"nowrap",width:"100%"}},art("H2",{style:{overflowX:"auto"}},"Round: ",C),y);art.a("h2",{display:"table-cell",font:"24px Verdana"});art(document.body,{style:{color:"#33A",WebkitTapHighlightColor:"transparent",s:"none",MozUserSelect:"none",WebkitUserSelect:"none"}},art("DIV",{style:{margin:"0 auto",width:"300px"}},a,b,g))}))})();